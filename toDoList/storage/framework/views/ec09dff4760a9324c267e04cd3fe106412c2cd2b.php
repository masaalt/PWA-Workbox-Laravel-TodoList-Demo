        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
            ...
            <table class="w-full text-md rounded mb-4" id = "">
                ...
                <?php $__currentLoopData = auth()->user()->tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-b hover:bg-orange-100" id = "<?php echo e($task->id); ?>">
                        <td class="p-3 px-5">
                        ...
                        <td class="p-3 px-5">
                            ...
                            <form action="/task/<?php echo e($task->id); ?>" class="inline-block" id = "form-del-<?php echo e($task->id); ?>" method="POST">
                                <?php echo e(csrf_field()); ?>

                                <button id = "del-<?php echo e($task->id); ?>" method="POST" type="submit" name="delete" class="text-sm bg-red-500 hover:bg-red-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">Delete</button>
                    ...
                    <!-- <script>
                        $(document).ready(function() {
                            ...
                            var form=$("#form-del-<?php echo e($task->id); ?>");
                            $(document).on('click', '#del-<?php echo e($task->id); ?>', async function (e) {
                                e.preventDefault();
                                if (navigator.onLine){
                                    $.ajax({
                                    type: 'delete',
                                ...
                                if (!navigator.onLine){
                                    document.getElementById("form-del-<?php echo e($task->id); ?>").submit();
                                }
                                document.getElementById("<?php echo e($task->id); ?>").remove();
                                    });
                                });                      
                                    ...
                                    count.onsuccess = function() {
                                        ...
                                        // report the success of our request
                                            ...
                                            myRecord.event.forEach(function(element) {
                                                    if (element.id != "<?php echo e($task->id); ?>"){
                ...
                <div class="flex-auto text-right mt-2">
                   <form method="POST" action="/send">
                        ...
                        <div class="form-group">
                            ...
                            <?php if($errors->has('nitif')): ?>
                                <span class="text-danger"><?php echo e($errors->first('nitif')); ?></span>
                            <?php endif; ?>
                        </div>
...
<?php endif; ?><?php /**PATH C:\sarase\second_project\todoApp\resources\views/dashboard.blade.php ENDPATH**/ ?>